        ...
        <div className={styles.content}>
          ...
          <div className={styles.headerSection}>
            ...
            <h1 className={styles.heading}>
              Master the <span className={styles.highlight}>ATI TEAS 7</span> Exam
            </h1>
            
            <p className={styles.description}>
              Unlock your nursing school dreams with our comprehensive TEAS 7 preparation program. 
