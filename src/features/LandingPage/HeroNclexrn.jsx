        ...
        <div className={styles.content}>
          ...
          <div className={styles.headerSection}>
            ...
            <h1 className={styles.heading}>
              Master the <span className={styles.highlight}>Nclex - RN</span>
            </h1>
            
            <p className={styles.description}>
              Unlock your nursing school dreams with our comprehensive NCLEX RN preparation program. 
