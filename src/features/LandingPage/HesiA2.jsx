        ...
        <div className={styles.content}>
          ...
          <div className={styles.headerSection}>
            ...
            <h1 className={styles.heading}>
              Master <span className={styles.highlight}>HESI A2</span> Exams
            </h1>
            
            <p className={styles.description}>
              Unlock your nursing school dreams with our comprehensive Hesi A2 Exams preparation program. 
