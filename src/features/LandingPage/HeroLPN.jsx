        ...
        <div className={styles.content}>
          ...
          <div className={styles.headerSection}>
            ...
            <h1 className={styles.heading}>
              Master the <span className={styles.highlight}>LPN Nursing</span> TestBank
            </h1>
            
            <p className={styles.description}>
              Unlock your nursing school dreams with our comprehensive LPN TestBank preparation program. 
