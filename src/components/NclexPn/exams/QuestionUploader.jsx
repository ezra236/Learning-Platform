...
export default function QuestionUploader() {
  ...
  async function markExamCompleted() {
    ...
    try {
      const resp = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/prep/exams/${selectedExam}/`, {
        method: 'PATCH',
        credentials: 'include',
        headers: {
  ...
  async function uploadImage(file) {
    ...
    await fetchCsrf();
    const resp = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/prep/upload-image/`, {
      method: 'POST',
      credentials: 'include',
      headers: {
  ...
  async function handleSubmit(e) {
    ...
    const resp = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/prep/questions/create/`, {
      method: 'POST',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
