// components/ExitExams.js
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faGraduationCap, faUsers, faCheckCircle, faUpload } from '@fortawesome/free-solid-svg-icons';
import styles from './ExitExams.module.css';

export default function ExitExams() {
  const stats = {
    registeredUsers: 9800,
    examsCompleted: 7200,
    questionsUploaded: 31000
  };
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <h2 className={styles.title}>Exit Exams</h2>
      </div>
