...
const links = [
  ...
  { href: '/admin/pricing', label: 'Pricing', icon: faTags },
  { href: '/admin/assistants', label: 'Assistants', icon: faUserFriends },
  { href: '/admin/statistics', label: 'Statistics', icon: faChartBar },
  { href: '/admin/exams/dashboard', label: 'Exams Dashboard', icon: faClipboardList },
  { href: '/admin/testimonial', label: 'Testimonials', icon: faComments },
  { href: '/admin/reviews', label: 'Reviews', icon: faStarHalfAlt }, 
