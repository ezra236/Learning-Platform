...
export default function ExamQuestionEditor() {
  ...
  useEffect(() => {
    async function loadExams() {
      ...
      try {
        ...
        const res = await fetch(`${apiBase}/api/hesi/`, { credentials: 'include' });
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        const res = await fetch(`${apiBase}/api/hesi/${examId}/`, { credentials: 'include' });
  ...
  async function handleSave() {
    ...
    try {
      ...
      const res = await fetch(`${apiBase}/api/hesi/questions/${question.id}/`, {
        method: 'PATCH',
        body: fd,
        credentials: 'include',
        headers: {
