...
export default function QuestionUploader() {
  ...
  async function fetchExams() {
    ...
    setFetchError(null);
    try {
      const res = await fetch(`${apiBase}/api/hesi/`, { method: 'GET', credentials: 'include' });
  ...
  async function createExam(e) {
    ...
    try {
      ...
      const res = await fetch(`${apiBase}/api/hesi/`, {
        method: 'POST',
        headers: { 
  ...
  async function markExamCompleted() {
    ...
    try {
      const token = csrfToken || await fetchCsrfToken();
      const res = await fetch(`${apiBase}/api/hesi/${examId}/`, {
        method: 'PATCH',
        headers: { 
          'Content-Type': 'application/json',
          ...(token ? { 'X-CSRFToken': token } : {})
  ...
  async function submit(e) {
    ...
    try {
      ...
      const res = await fetch(`${apiBase}/api/hesi/questions/`, { 
        method: 'POST', 
        body: fd,
        credentials: 'include',
        headers: {
