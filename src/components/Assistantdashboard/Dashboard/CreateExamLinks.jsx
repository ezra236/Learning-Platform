  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.grid}>
        {/* Quick Exam Card */}
        <a href="/assistant/exams/create/ati/" className={`${styles.linkCard} ${styles.quickExam}`}>
        ...
        {/* Template Card */}
        <a href="/assistant/exams/create/hesi/" className={`${styles.linkCard} ${styles.template}`}>
          <div className={styles.cardContent}>
            <span className={styles.linkIcon}>📝</span>
            <div className={styles.linkContent}>
        ...
        {/* Advanced Card */}
        <a href="/assistant/exams/create/nclexrn/" className={`${styles.linkCard} ${styles.advanced}`}>
          <div className={styles.cardContent}>
            <span className={styles.linkIcon}>📝</span>
            <div className={styles.linkContent}>
        ...
        {/* Timed Exam Card */}
        <a href="/assistant/exams/create/nclexpn/" className={`${styles.linkCard} ${styles.timedExam}`}>
          <div className={styles.cardContent}>
           <span className={styles.linkIcon}>📝</span>
            <div className={styles.linkContent}>
        ...
        {/* Practice Test Card */}
        <a href="/assistant/exams/create/rn/" className={`${styles.linkCard} ${styles.practiceTest}`}>
          <div className={styles.cardContent}>
            <span className={styles.linkIcon}>📝</span>
            <div className={styles.linkContent}>
        ...
        {/* Graded Exam Card */}
        <a href="/assistant/exams/create/lpn/" className={`${styles.linkCard} ${styles.gradedExam}`}>
          <div className={styles.cardContent}>
            <span className={styles.linkIcon}>📝</span>
            <div className={styles.linkContent}>
