// components/bookmarks/formats/Format3.jsx
import React from "react";
import styles from "./Format3.module.css";

export default function Format3({ question, choices = [], specialchoices = [], user_selected }) {
      ...
      {question.image_url && (
        <div className={styles.imageSection}>
          <div className={styles.sectionHeader}>
            ...
            <h3 className={styles.sectionTitle}>Visual Reference</h3>
          </div>
          <div className={styles.imageContainer}>
            <img 
              src={question.image_url} 
              alt="Passage visual reference" 
