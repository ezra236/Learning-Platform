// Exams/ExamDashboard/ATIDashboard.jsx
"use client";
...
export default function ATIDashboard({ exams = [] }) {
  ...
  const openMode = async (mode, examName) => {
    ...
    try {
      ...
      const path = `/user/ati/${mode}/${encoded}`;
      router.push(path);
    } catch (error) {
  ...
  if (!exams || exams.length === 0) {
    return (
      <div className={styles.emptyState}>
        ...
        <h3 className={styles.emptyTitle}>No ATI Exams Available for this group</h3>
        <p className={styles.emptyMessage}>ATI TEAS 7 preparation materials</p>
        ...
        >
          ...
          <div className={styles.examHeader}>
            ...
            <div className={styles.examInfo}>
              ...
              <p className={styles.examDescription}>ATI TEAS 7 Comprehensive Preparation</p>
