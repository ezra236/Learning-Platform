...
export default function Format6({ question, mode, selectedAnswer, onAnswer, onBookmark, onReport }) {
    ...
    <div className={styles.container}>
      <div className={styles.questionHeader}>
        <div className={styles.questionMeta}>
          <span className={styles.questionType}>Reading Passage with Table</span>
