// components/HesiProgress.jsx
import React, { useEffect, useState } from "react";
import styles from "./HesiProgress.module.css";
...
export default function HesiProgress() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await fetch(`${base}/api/progress/hesi/`, {
          method: "GET",
          credentials: "include",
        ...
        console.error("HESI progress error", err);
  ...
  if (loading) return (
    <div className={styles.loading}>
      <div className={styles.loadingContent}>
        ...
        <div className={styles.loadingTitle}>Loading HESI Progress</div>
  ...
  if (!data) return (
    <div className={styles.error}>
      <div className={styles.errorContent}>
        ...
        <div className={styles.errorTitle}>Unable to load HESI progress</div>
  ...
  const chartColors = ['#EF4444', '#F59E0B', '#10B981', '#3B82F6', '#8B5CF6', '#06B6D4', '#F97316', '#84CC16'];
      ...
      <div className={styles.summary}>
        <div className={styles.card}>
          ...
          <div className={styles.cardContent}>
            ...
            <div className={styles.label}>HESI Exams</div>
          </div>
              ...
              data={{ 
                ...
                datasets: [{ 
                  ...
                  backgroundColor: barData.map((value, index) => 
                    `hsl(${0 + index * 30}, 80%, 60%)`
                  ),
                  borderColor: barData.map((value, index) => 
                    `hsl(${0 + index * 30}, 80%, 45%)`
                  ),
                  borderWidth: 2,
                  borderRadius: 8,
                  borderSkipped: false,
